...
namespace Tests.UnitTest {
    ...
    public class Order_UT {
        ...
        PizzaBox.Domain.Models.Orders records = new PizzaBox.Domain.Models.Orders ();
        PizzaBox.Domain.Models.Elements.Order record = new PizzaBox.Domain.Models.Elements.Order ();
        ...
        public void Read () {
            ...
            var query = new PizzaBox.Domain.Models.Elements.OrderQuery { Id = record.Id };
        ...
        public void Delete () {
            ...
            /*PizzaBox.Domain.Models.Elements.Order record = new PizzaBox.Domain.Models.Elements.Order (
                ...
                new PizzaBox.Data.Entities.Order { Id = System.Guid.Parse ( "3BB6D505-A364-4795-8312-F70A6D8E1890" ) }
            ...
            using ( var context = new PizzaBox.Data.PizzaBoxDbContext () )
                if ( context.People.Orders ( record.Id ) == null )
