...
namespace Tests.UnitTest {
    ...
    public class Business_UT {
        ...
        PizzaBox.Domain.Models.Businesses records = new PizzaBox.Domain.Models.Businesses ();
        PizzaBox.Domain.Models.Elements.Business record = new PizzaBox.Domain.Models.Elements.Business ();

        [ Test ]
        public void Write () {

            record.Name = "Test Pizzoria";
        ...
        public void Read () {
            ...
            var query = new PizzaBox.Domain.Models.Elements.BusinessQuery { Name = "Test Pizzoria" };

            if ( records.Query ( ref query ) != null ) Assert.Pass (); else Assert.Fail ();
        ...
        public void Delete () {
            ...
            /// Due to the concurrency constraints of Entity Framework and the execution of NUnit deletion testing
            ...
            /// 3. Comment out the default 'Assert.Pass' and uncomment the group comment 
            /// 4. Run the 'Delete' test indiviually
            /// 5. Restore when complete

            /*PizzaBox.Domain.Models.Elements.Business record = new PizzaBox.Domain.Models.Elements.Business (
            
                new PizzaBox.Data.Entities.Outlet { Id = System.Guid.Parse ( "3BB6D505-A364-4795-8312-F70A6D8E1890" ) }
